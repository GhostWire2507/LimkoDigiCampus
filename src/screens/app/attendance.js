...
import { getAttendanceForRole, getClassesForRole, saveAttendance } from "../../services/dataService";
...
function AttendanceScreen() {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      <AppHeader title="Attendance" subtitle="Record presence by lecture session and track attendance rate over time." />
